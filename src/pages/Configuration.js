...
import Captaion from "../icons/captaion.png";
...
function Configuration() {
  const configOrderItems = [
    ...
    { name: "Captaion Connect", icon: Captaion, navigateTo: "captaion" },
  ];
  ...
  const configRestaurantItems = [
    ...
    {
      name: "Bill / KOT Print",
      icon: BilKotPrintIcon,
      navigateTo: "printerConfig",
    },
    { name: "Tax", icon: TaxIcon, navigateTo: "../LiveView/KOTView" },
    { name: "Discount", icon: DiscountIcon, navigateTo: "" },
    {
      name: "Billing Screen",
      icon: BillingStationIcon,
      navigateTo: "billingScreenConfig",
    },
    ...
    >
      ...
      <main className={styles.configMain}>
        ...
        <div className={styles.configBody}>
          ...
          <div className={styles.configRestaurantTitle}>
