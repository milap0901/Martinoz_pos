...
function OrderExistAlertModal({
  ...
  const { mutate, isLoading } = useUpdateOrderAndCreateKOTMutation(
    printers,
    hide,
    finalOrder,
    shouldPrintKOT,
      ...
      <Modal.Body className={styles.modalBody}>
        <Row>
          <Col className={styles.message}>
            Dine In order for same table number is currently active do you want
            to merger the KOT with active order
          </Col>
        </Row>
        <Row>
