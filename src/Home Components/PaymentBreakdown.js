...
function PaymentBreakdown({ showPaymentBreakdown, setShowPaymentBreakdown }) {
  ...
  return (
    <div className={showBreakdown} ref={outsideRef}>
      <button
        className={styles.breakDownHideBtn}
      ...
      <div
        className={`${styles.breakDownItem} d-flex justify-content-between py-1 align-items-center`}
      >
        ...
        <input
          ...
          name="deliveryCharge"
          value={finalOrder.deliveryCharge || ""}
          placeholder="0"
        />
      </div>
      <div
      ...
      >
        ...
        <input
          ...
          value={finalOrder.packagingCharge || ""}
          placeholder="0"
        />
      </div>
      <div className={`${styles.breakDownItem} d-flex justify-content-between`}>
