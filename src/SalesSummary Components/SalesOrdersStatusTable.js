      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              {salesTotalSummary?.totalSettleAmount?.saved.toLocaleString(
                "en-US",
                {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
          ...
          <tr>
            <td>Printed</td>
            <td>
              {salesTotalSummary?.totalMyAmount?.printed.toLocaleString(
                "en-US",
                {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
            ...
            <td>
              {salesTotalSummary?.totalSettleAmount?.printed.toLocaleString(
                "en-US",
                {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
          ...
          <tr>
            <td>Cancelled</td>
            <td>
              {salesTotalSummary?.totalMyAmount?.cancelled.toLocaleString(
                "en-US",
                {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
            ...
            <td>
              {salesTotalSummary?.totalSettleAmount?.cancelled.toLocaleString(
                "en-US",
                {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
        ...
        <tfoot>
          <tr>
            ...
            <th>
              {salesTotalSummary?.totalSettleAmount?.total.toLocaleString(
                "en-US",
                {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
