...
function AssignPrinterToKot({
  printerKotOrderType,
  setPrinterKotOrderType,
  printer,
  setPrinter,
}) {
      ...
      <header>
        <input
          ...
          onChange={() =>
            setPrinter((prev) => ({
              ...prev,
              assignToKotStatus: !prev.assignToKotStatus,
            }))
          }
        />
        <label className={styles.headerText} htmlFor={"kotStatus"}>
                ...
                <div className={styles.tableRow} key={orderType.order_type}>
                  ...
                  <div className={styles.countControl}>
                    <input
                      ...
                      disabled={
                        !orderType.isChecked || !printer.assignToKotStatus
                      }
                    />
                  </div>
                </div>
