...
function AssignPrinterToBill({
  printerBillOrderType,
  setPrinterBillOrderType,
  printer,
  setPrinter,
}) {
      ...
      <header>
        <input
          ...
          onChange={() =>
            setPrinter((prev) => ({
              ...prev,
              assignToBillStatus: !prev.assignToBillStatus,
            }))
          }
        />
        <label className={styles.headerText} htmlFor={"billStatus"}>
                ...
                <div className={styles.tableRow} key={orderType.order_type}>
                  ...
                  <div className={styles.countControl}>
                    <input
                      ...
                      disabled={
                        !orderType.isChecked || !printer.assignToBillStatus
                      }
                    />
                  </div>
                </div>
